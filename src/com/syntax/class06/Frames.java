...
//      Task:2  check the check box
//Switch to the main page
        driver.switchTo().defaultContent();

//        switch to the frame containing the subframe which has checkbox
        driver.switchTo().frame("frame1"); //note inorder to reach the sub frame/child we have to go the parent frame first then we have to go to child/sub frame.line 41 & 42
